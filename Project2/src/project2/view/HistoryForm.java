...
public class HistoryForm extends javax.swing.JFrame {
    ...
    String sql="Select id_history as Id ,name,date_times as Time FROM History order by id_history asc";
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtSearchHistory, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtSearchHistoryKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchHistoryKeyPressed
        if(txtSearchHistory.getForeground()!=Color.BLACK){
            if(txtSearchHistory.getText().equals("Search History")){
                txtSearchHistory.setText("");
            }
        }
        txtSearchHistory.setForeground(Color.BLACK);
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            try {
                String nameSearch = txtSearchHistory.getText();
                String sqlSearchName = "Select id_history as Id ,name,date_times as Time from History where name='"+nameSearch.trim()+"'";
                pst =cnn.prepareStatement(sqlSearchName);
                rs = pst.executeQuery();
                if(rs.next()){
    ...
    }//GEN-LAST:event_txtSearchHistoryKeyPressed
